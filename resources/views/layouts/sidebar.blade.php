    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="{{ route('wahana') }}" class="nav-link menu-link"> <i class="ti ti-messages"></i> <span data-key="t-chat">Wahana</span> </a>
                </li>

                <li class="menu-title"><i class="ti ti-dots"></i> <span data-key="t-apps">FAQ</span></li>

                 <li class="nav-item">
                    <a href="{{ route('question') }}" class="nav-link menu-link"> <i class="ti ti-mail"></i> <span data-key="t-email">question</span> </a>
                </li>
