    ...
    function loadCountryListData(datas) {
        ...
        for (let index = 0; index < arr.length; index++) {
            ...
            <div class="flex-shrink-0 me-2"><img src="'+ arr[index]['flagImg'] + '" alt="country flag" class="options-flagimg" height="20"></div>\
                ...
                <div class="d-flex"><div class="country-name me-1">'+ arr[index]['countryName'] + '</div><span class="countrylist-codeno text-muted">' + '</span></div>\
            </div>\
            </li>';
        }
            ...
            searchInput.addEventListener("keyup", function () {
                ...
                setTimeout(function () {
                    ...
                    Array.from(filterData).forEach(function (listData) {
                        ...
                        <div class="flex-grow-1">\
                        <div class="d-flex"><div class="country-name me-1">'+ listData.countryName + '</div><span class="countrylist-codeno text-muted">' + '</span></div>\
                        </div>\
                        </li>';
                    });
